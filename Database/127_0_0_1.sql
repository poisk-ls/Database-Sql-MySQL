...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2022 at 01:32 PM
...
-- Database: `Gly_za`
--
CREATE DATABASE IF NOT EXISTS `Gly_za` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `Gly_za`;
...
CREATE TABLE `customer` (
  ...
  `course` varchar(12) NOT NULL DEFAULT '',
  `age` varchar(95) NOT NULL DEFAULT ''
...
INSERT INTO `customer` (`cust_id`, `name`, `email`, `address`, `phone_no`, `orders`, `status`, `course`, `age`) VALUES
(1, 'honey', 'gshsv@gmail.com', 'kulo', '+63 04944488978', 'groceries', 'single', 'IT', '25'),
...
--
CREATE DATABASE IF NOT EXISTS `kindergartens` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci;
USE `kindergartens`;
...
-- Database: `sir_junie`
--
CREATE DATABASE IF NOT EXISTS `sir_junie` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `sir_junie`;
